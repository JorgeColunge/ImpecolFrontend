      ...
      <div className="App d-flex">
        ...
        >
              <Routes>
                ...
                <Route path="/inspection/:inspectionId" element={isAuthorized(["Supervisor Técnico", "Administrador", "Superadministrador", "Operario Hogar","Operario", "Cliente"]) ? <Inspection /> : <Navigate to="/login" />} />
